...
$locationlist = Yii::$app->utility->get_erss_placeofposting();
$locationlist = ArrayHelper::map($locationlist, 'id','location');


$ranklist = Yii::$app->utility->get_rank_list();
$ranklist = ArrayHelper::map($ranklist, 'id', 'type');

//ERSS JOB PROFILE


$erss_job_profile = Yii::$app->utility->get_erss_jobprofile();
$erss_job_profile = ArrayHelper::map($erss_job_profile, 'erss_job_profile', 'erss_job_profile');
//-----------------
...
<input type="hidden" readonly="" id="menuid" name="Employee[menuid]" value="<?=$menuid?>" />
    <div class="row">
        ...
        <div class="col-sm-3"><?= $form->field($model, 'rank1')->dropDownList($ranklist, ['class'=>'form-control form-control-sm', 'prompt' => 'Select Rank']) ?></div>
        <div class="col-sm-3"><?= $form->field($model, 'substantive_rnk')->textInput(['placeholder'=>'Rank/Name/Bno/', 'class'=>'form-control form-control-sm', 'maxlength' => true]) ?></div>

        <div class="col-sm-3"><?= $form->field($model, 'belt_no')->textInput(['placeholder'=>'Belt No', 'class'=>'form-control form-control-sm', 'maxlength' => true]) ?></div>
        <div class="col-sm-3"><?= $form->field($model, 'unit')->dropDownList($unitlist, ['class'=>'form-control form-control-sm', 'prompt' => 'Select Unit']) ?></div>
        <div class="col-sm-3"><?= $form->field($model, 'location')->dropDownList($locationlist, ['class'=>'form-control form-control-sm', 'prompt' => 'Select Place of Posting']) ?></div>
        ...
        <div class="col-sm-3"><?= $form->field($model, 'citizenship')->textInput(['placeholder'=>'citizenship', 'class'=>'form-control form-control-sm', 'maxlength' => true]) ?></div>
        <div class="col-sm-3"><?= $form->field($model, 'office_ord_no')->textInput(['placeholder'=>'office_ord_no', 'class'=>'form-control form-control-sm', 'maxlength' => true]) ?></div>
        <div class="col-sm-3"><?= $form->field($model, 'posting_remarks')->textInput(['placeholder'=>'Remarks', 'class'=>'form-control form-control-sm', 'maxlength' => true]) ?></div>
        ...
        <div class="col-sm-3">
          ...
          <div class="col-sm-3">
            <div class="form-group field-employee-driving required">
                <label class="control-label" for="employee-passport_detail">Driving License no.</label>
                <input type="text" id="employee-passport_detail" class="form-control form-control-sm" name="Employee[license_no]" placeholder="Driving License no" aria-required="true">
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-group field-employee-Expired_date required">
                <label class="control-label" for="employee-passport_detail">License Expired Date</label>
                <input type="text" id="employee-passport_detail" class="form-control form-control-sm employee-date" name="Employee[license_expired_date]" placeholder="License Expired Date" aria-required="true">
            </div>
        </div>
    </div>

    <div class="inrhead">Haryana Dial 112 ERSS Details</div>
    <div class="row">
        <div class="col-sm-3"><?= $form->field($model, 'erss_job_profile')->dropDownList($erss_job_profile, ['class'=>'form-control form-control-sm', 'prompt' => 'Select ERSS Job Profile']) ?></div>
        <div class="col-sm-3"><?= $form->field($model, 'erv_deployed')->dropDownList(['Y' => 'Yes', 'N' => 'No'],['class'=>'form-control form-control-sm', 'prompt' => 'Select ERV Status']) ?></div>
        <div class="col-sm-3"><?= $form->field($model, 'offclocation')->dropDownList(['SERC' => 'SERC', 'MERC' => 'MERC'], ['class'=>'form-control form-control-sm', 'prompt' => 'Select ERSS Office Location']) ?></div>
	...
	<div class="row">
        ...
        <div class="row">
            <div class="col-sm-3"><?= $form->field($model, 'employment_type')->dropDownList([ 'R' => 'Regular', 'C' => 'Contract','T' => 'Trainees' ], ['class'=>'form-control form-control-sm']) ?></div>
            ...
            <div class="col-sm-3"><?= $form->field($model, 'desg_id')->dropDownList($desgs, ['prompt'=>'Select Designation', 'class'=>'form-control form-control-sm']); ?></div>
             <div class="col-sm-3"><?= $form->field($model, 'confirmation_date')->textInput(['placeholder'=>'Confirmation Date', 'class'=>'form-control form-control-sm employee-date', 'maxlength' => true]) ?></div>
            <div class="col-sm-3"><?= $form->field($model, 'probation_from')->textInput(['placeholder'=>'Probation Date From', 'class'=>'form-control form-control-sm employee-date', 'maxlength' => true]) ?></div>
            <div class="col-sm-3"><?= $form->field($model, 'probation_to')->textInput(['placeholder'=>'Probation Date to', 'class'=>'form-control form-control-sm employee-date', 'maxlength' => true]) ?></div>
